...
from projects.mask2former.configs.models.mask2former_swin_large import model
from detrex.projects.maskdino.configs.data.coco_instance_seg import dataloader

train = get_config("common/train.py").train
train.output_dir = "./output/mask2former_swin_large_100ep"
...
# optimizer = L(bnb.optim.AdamW8bit)(
