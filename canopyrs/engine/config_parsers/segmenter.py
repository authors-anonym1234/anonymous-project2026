...
class SegmenterConfig(BaseConfig):
    ...
    full_eval_jobs: bool = False
    full_eval_every_n_epochs: int = 1
    full_eval_pipeline_config_path: Optional[str] = None
    full_eval_output_root: Optional[str] = None

    full_eval_fold: str = 'valid'
    full_eval_evaluate_tile: bool = True
    full_eval_evaluate_raster: bool = False
    full_eval_metrics_output_dir: Optional[str] = None
    full_eval_tile_max_dets: List[int] = Field(default_factory=lambda: [1, 10, 100, 400])
    full_eval_compute_segmentation_quality: bool = False
    full_eval_compute_pq: bool = False
    full_eval_raster_use_single_iou: bool = True
    full_eval_raster_single_iou_threshold: float = 0.5
